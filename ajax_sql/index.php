...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Album Flower</h1>
            <p class="lead text-muted">
                Here are pictures of beautiful flowers that I would like to introduce you. Hope you will like them.</p>
            <p>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#load-more').on('click', function(e) {
            ...
            e.preventDefault();
            var params = {};
            params.offset = $('.album-list').children('.col-md-4').length;// dem cac ban ghi .
            params.limit = 3;
            params.type = 'product';

            jQuery.ajax({
                url : 'http://localhost/ajax_loadmore_product/ajax_sql/ajax.php',
                data: params,
                type: 'POST',
                dataType: 'json',
                beforeSend: function() {
